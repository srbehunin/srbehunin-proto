...
pub mod app_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_app_by_handle(
            ...
            tonic::Response<super::GetAppByHandleResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn set_app_status(
            ...
            tonic::Response<super::SetAppStatusResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn get_all(
            ...
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("app.v1.AppService", "GetAll"));
            self.inner.unary(req, path, codec).await
        }
    }
}
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/app.v1.AppService/GetAppById" => {
                    ...
                    impl<
                        T: AppService,
                    > tonic::server::UnaryService<super::GetAppByIdRequest>
                    for GetAppByIdSvc<T> {
                ...
                "/app.v1.AppService/GetAppByHandle" => {
                    ...
                    impl<
                        T: AppService,
                    > tonic::server::UnaryService<super::GetAppByHandleRequest>
                ...
                "/app.v1.AppService/SetAppStatus" => {
                    ...
                    impl<
                        T: AppService,
                    > tonic::server::UnaryService<super::SetAppStatusRequest>
                    for SetAppStatusSvc<T> {
                ...
                "/app.v1.AppService/GetAll" => {
                    ...
                    impl<T: AppService> tonic::server::UnaryService<super::GetAllRequest>
                    for GetAllSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AppService>::get_all(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
